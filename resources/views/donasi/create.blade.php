...
@section('content')
    ...
    <div class="container bg-white w-[80rem] mx-auto p-8 mt-20 flex flex-col items-center rounded-[20px] "
        ...
        <div class="w-[45rem]">
            <h3 class="text-center mb-5 text-4xl font-bold">Donatur Service
            </h3>
            ...
            <div class="flex justify-center items-center min-h-screen bg-white">
                <div class="w-[35rem] bg-white p-6 rounded-lg">
                    <form action="{{ route('donasi.store') }}" method="POST" class="w-full">
                        @csrf
                        <div class="form-group mb-4">
                            ...
                            <input type="text" id="nama_donatur" name="nama_donatur"
                                ...
                                value="{{ old('nama_donatur') }}" required placeholder="Nama">
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="number" id="nominal" name="nominal"
                                class="form-control border-2 w-full border-gray-500 h-[3rem] rounded-2xl p-4"
                                value="{{ old('nominal') }}" required min="1000" placeholder="Masukan Nominal">
                        </div>
                        ...
                        <div class="mb-4 form-group">
                            ...
                            <select name="metode_pembayaran" id="metode_pembayaran"
                                ...
                                <option value="MANDIRI" {{ old('metode_pembayaran') == 'MANDIRI' ? 'selected' : '' }}>Mandiri
                                </option>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="date" id="tanggal_donasi" name="tanggal_donasi"
                                class="form-control border-2 w-full border-gray-500 h-[3rem] rounded-2xl p-4"
                                value="{{ old('tanggal_donasi') }}" required>
                        </div>

                        <div class="form-group mb-4">
                            <label for="dukungan_doa" class="font-semibold">Status</label>
                            <input type="text" id="dukungan_doa" name="dukungan_doa"
                                ...
                                value="{{ old('dukungan_doa') }}" placeholder="Berikan Pesan">
                        </div>

                        <div class="form-group mb-4">
                            <label for="status" class="font-semibold">Status:</label>
                            <select name="status" id="status" class="form-control border-2 w-full border-gray-500 h-[4rem] rounded-2xl p-4" required>
                                <option value="menunggu konfirmasi" {{ old('status') == 'menunggu konfirmasi' ? 'selected' : '' }}>Menunggu Konfirmasi</option>
